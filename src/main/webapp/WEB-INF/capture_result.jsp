					...
					<div class="col-md-12 col-sm-12">
						<div class="x_panel">
							<jsp:include page="common/bodyHead.jsp">
								<jsp:param name="pageTitle" value="CaptureResult"/>
							</jsp:include>
							<div class="x_content">
								<form class="form-horizontal form-label-left" novalidate 
									  name="captureResultForm" id="captureResultForm" method="post">
									...
									<div class="form-group btn">
										<div class="col-md-12 offset-md-6">
											<button type="button" onclick="autoSubmit('../void/init');" class="btn btn-primary">goVoid</button>
											<button type="button" onclick="autoSubmit('../refund/init');" class="btn btn-primary">goRefund</button>
											<button type="button" onclick="autoSubmit('../capture/init');" class="btn btn-success">goCapture</button>
										</div>
									</div>
								</form>
							</div>
