					...
					<div class="col-md-12 col-sm-12">
						<div class="x_panel">
							<jsp:include page="common/bodyHead.jsp">
								<jsp:param name="pageTitle" value="SaleResult"/>
							</jsp:include>
							<div class="x_content">
								<form class="form-horizontal form-label-left" novalidate name="authorizeResultForm" id="authorizeResultForm" method="post">
									...
									<div class="form-group btn">
										<div class="col-md-6 offset-md-3">
											<button type="button" onclick="autoSubmit('../void/init');" class="btn btn-primary">go void</button>
											<button type="button" onclick="autoSubmit('../refund/init');" class="btn btn-primary">go refund</button>
											<button type="button" onclick="autoSubmit('../sale/init');" class="btn btn-success">next sale</button>
										</div>
									</div>void
								</form>
							</div>
